...
import com.example.studiz.global.jwt.RedisRefreshToken; // <- 여기 임포트 변경됨!
...
public class ReissueService {
    ...
    public TokenResponse reissue(String refreshToken) {
        ...
        // 3. Redis에 저장된 토큰인지 확인 (타입이 RedisRefreshToken으로 변경됨!)
        RedisRefreshToken savedToken = redisRefreshTokenRepository.findById(userId)
        ...
        redisRefreshTokenRepository.save(savedToken);
